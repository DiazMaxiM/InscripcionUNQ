...
public class OfertaAcademicaController {
	...
	@DeleteMapping("/ofertas-academicas/eliminarOferta/{idOferta}")
	public ResponseEntity eliminarCarrera(@PathVariable String idOferta) {
		try {
			ofertaAcademicaServiceImpl.eliminarOferta(idOferta);
		}
		catch (IdNumberFormatException | OfertaNoExisteException e) {
