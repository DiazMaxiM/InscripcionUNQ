...
public class LoadInitialDataController {
	...
	public void loadData() throws ObjectNotFoundinDBException {
		...
		commMate1.addHours(TypeDay.MARTES, LocalTime.of(9, 00), 4.0f);
		commMate1.addHours(TypeDay.JUEVES, LocalTime.of(9, 00), 4.0f);
		...
		commMate2.addHours(TypeDay.LUNES, LocalTime.of(18, 00), (float) 4.0f);
		commMate2.addHours(TypeDay.MIERCOLES, LocalTime.of(18, 00), 4.0f);
		...
		commMate3.addHours(TypeDay.LUNES, LocalTime.of(9, 00), 4.0f);
		commMate3.addHours(TypeDay.MIERCOLES, LocalTime.of(9, 00), 4.0f);
		...
		commInPr1.addHours(TypeDay.LUNES, LocalTime.of(9, 00), 2.5f);
		commInPr1.addHours(TypeDay.JUEVES, LocalTime.of(9, 00), 2.5f);
		commInPr1.addHours(TypeDay.MIERCOLES, LocalTime.of(8, 00), 3.0f);
		...
		commInPr2.addHours(TypeDay.LUNES, LocalTime.of(12, 00), 2.5f);
		commInPr2.addHours(TypeDay.JUEVES, LocalTime.of(12, 00), 2.5f);
		commInPr2.addHours(TypeDay.MIERCOLES, LocalTime.of(8, 00), 3.0f);
		...
		commInPr3.addHours(TypeDay.LUNES, LocalTime.of(15, 00), 2.5f);
		commInPr3.addHours(TypeDay.JUEVES, LocalTime.of(15, 00), 2.5f);
		commInPr3.addHours(TypeDay.MIERCOLES, LocalTime.of(18, 00), 3.0f);
		...
		commInPr4.addHours(TypeDay.LUNES, LocalTime.of(19, 00), 2.5f);
		commInPr4.addHours(TypeDay.JUEVES, LocalTime.of(19, 00), 2.5f);
		commInPr4.addHours(TypeDay.MIERCOLES, LocalTime.of(18, 00), 3.0f);
		...
		commOrga1.addHours(TypeDay.MARTES, LocalTime.of(8, 00), 3.0f);
		commOrga1.addHours(TypeDay.VIERNES, LocalTime.of(8, 00), 3f);
		...
		commOrga2.addHours(TypeDay.MARTES, LocalTime.of(11, 00), 3.0f);
		commOrga2.addHours(TypeDay.VIERNES, LocalTime.of(11, 00), 3f);
		...
		commOrga3.addHours(TypeDay.MARTES, LocalTime.of(16, 00), 3.0f);
		commOrga3.addHours(TypeDay.VIERNES, LocalTime.of(16, 00), 3f);
		...
		commOrga4.addHours(TypeDay.MARTES, LocalTime.of(19, 00), 3.0f);
		commOrga4.addHours(TypeDay.VIERNES, LocalTime.of(19, 00), 3f);
		...
		commed1.addHours(TypeDay.MARTES, LocalTime.of(18, 00), 3.0f);
		commed1.addHours(TypeDay.MIERCOLES, LocalTime.of(18, 00), 3f);
		commed1.addHours(TypeDay.SABADO, LocalTime.of(8, 00), 3f);
		...
		commobj11.addHours(TypeDay.MIERCOLES, LocalTime.of(14, 00), 4f);
		commobj11.addHours(TypeDay.SABADO, LocalTime.of(8, 00), 4f);
		...
		commobj12.addHours(TypeDay.LUNES, LocalTime.of(18, 00), 4f);
		commobj12.addHours(TypeDay.MARTES, LocalTime.of(18, 00), 4f);
		...
		commbd1.addHours(TypeDay.LUNES, LocalTime.of(18, 00), 3f);
		commbd1.addHours(TypeDay.JUEVES, LocalTime.of(18, 00), 3f);
		...
		commso1.addHours(TypeDay.JUEVES, LocalTime.of(16, 00), 6f);
		...
		commso2.addHours(TypeDay.MIERCOLES, LocalTime.of(18, 00), 4f);
		commso2.addHours(TypeDay.JUEVES, LocalTime.of(16, 00), 2f);
		...
		commredes1.addHours(TypeDay.MARTES, LocalTime.of(9, 00), 2f);
		commredes1.addHours(TypeDay.JUEVES, LocalTime.of(8, 00), 4f);
		...
		commredes2.addHours(TypeDay.MARTES, LocalTime.of(18, 00), 4f);
		commredes2.addHours(TypeDay.JUEVES, LocalTime.of(18, 00), 2f);
		...
		commobj21.addHours(TypeDay.LUNES, LocalTime.of(18, 00), 3f);
		commobj21.addHours(TypeDay.VIERNES, LocalTime.of(15, 00), 3f);
		...
		commobj22.addHours(TypeDay.LUNES, LocalTime.of(18, 00), 3f);
		commobj22.addHours(TypeDay.VIERNES, LocalTime.of(18, 00), 3f);
		...
		commMate21.addHours(TypeDay.JUEVES, LocalTime.of(18, 00), 4f);
		...
		commMate22.addHours(TypeDay.MARTES, LocalTime.of(16, 00), 2f);
		commMate22.addHours(TypeDay.MIERCOLES, LocalTime.of(16, 00), 2f);
		...
		commcIU1.addHours(TypeDay.JUEVES, LocalTime.of(16, 00), 6f);
		...
		commingS1.addHours(TypeDay.LUNES, LocalTime.of(19, 00), 3f);
		commingS1.addHours(TypeDay.MIERCOLES, LocalTime.of(19, 00), 3f);
		...
		commePers1.addHours(TypeDay.VIERNES, LocalTime.of(16, 00), 6f);
		...
		commlabo1.addHours(TypeDay.JUEVES, LocalTime.of(18, 00), 4f);
		...
		commpF1.addHours(TypeDay.MIERCOLES, LocalTime.of(15, 00), 2f);
		commpF1.addHours(TypeDay.SABADO, LocalTime.of(11, 00), 2f);
		...
		commdesa1.addHours(TypeDay.MARTES, LocalTime.of(16, 00), 6f);
		...
		commtip1.addHours(TypeDay.SABADO, LocalTime.of(8, 00), 5f);
		...
		commsI1.addHours(TypeDay.SABADO, LocalTime.of(9, 00), 4f);
		...
		commpc1.addHours(TypeDay.MIERCOLES, LocalTime.of(17, 00), 4f);
		...
		commobj3.addHours(TypeDay.MARTES, LocalTime.of(18, 00), 4f);
		...
		commcLP.addHours(TypeDay.MARTES, LocalTime.of(18, 00), 2f);
		commcLP.addHours(TypeDay.MIERCOLES, LocalTime.of(18, 00), 2f);
		...
		commlyp.addHours(TypeDay.LUNES, LocalTime.of(9, 00), 2f);
		commlyp.addHours(TypeDay.MARTES, LocalTime.of(9, 00), 2f);
		...
		commiDV.addHours(TypeDay.MIERCOLES, LocalTime.of(8, 00), 4f);
		...
		commingles2.addHours(TypeDay.MIERCOLES, LocalTime.of(14, 00), 3f);
