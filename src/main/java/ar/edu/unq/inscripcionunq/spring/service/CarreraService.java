...
public interface CarreraService extends GenericService<Carrera> {
	...
	void actualizarCarrera(CarreraJson carreraJson) throws DescripcionInvalidaException, CodigoInvalidoException, EstadoInvalidoException, ExisteCarreraConElMismoCodigoException, CarreraNoExisteException;
