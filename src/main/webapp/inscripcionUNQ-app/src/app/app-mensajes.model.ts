export class AppMensajes {

	public static NO_SE_ENCONTRARON_COMISIONES_EN_PERIODO = 'No se encontraron comisiones para el período buscado';
	public static NO_HAY_MATERIA_SELECCIONADA = 'Debe seleccionar una materia válida';
	public static NO_HAY_PERIODO_SELECCIONADO = 'Debe seleccionar un período válido';
	...
	public static CREACION_USUARIO_EXITOSO = 'El usuario fue creado con éxito';
	...
	public static MODIFICACION_PASSWORD_EXITOSO = 'La contraseña fue modificada con éxito';
	public static ADMINSTRADOR = 'ADMINISTRADOR';
	public static ESTUDIANTE = 'ESTUDIANTE';
	public static ACTUALIZACION_USUARIO_EXITOSO = 'El usuario fue actualizado con éxito';
	public static MODIFICACION_PERFIL_EXITOSO = 'El perfil del usuario fue actualizado con éxito';
	public static ACTUALIZACION_ENCUESTA_EXITOS0 = 'Los datos de la encuesta fueron actualizados con éxito';
